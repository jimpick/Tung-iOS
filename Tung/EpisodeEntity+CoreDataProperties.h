...
@property (nullable, nonatomic, retain) NSNumber *isDownloadingForSave;
@property (nullable, nonatomic, retain) NSNumber *isNowPlaying;
@property (nullable, nonatomic, retain) NSNumber *isQueuedForSave;
@property (nullable, nonatomic, retain) NSNumber *isRecommended;
@property (nullable, nonatomic, retain) NSNumber *isSaved;
@property (nullable, nonatomic, retain) NSDate *pubDate;
@property (nullable, nonatomic, retain) NSDate *savedUntilDate;
