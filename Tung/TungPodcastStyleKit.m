...
+ (void)drawFollowButtonWithFrame: (CGRect)frame on: (BOOL)on down: (BOOL)down
{
    ...
    //// Subframes
    CGRect follow = CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame), CGRectGetWidth(frame) - 4, 38);
    ...
    CGRect following = CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame), CGRectGetWidth(frame) - 2, 38);
    ...
    if (notOn)
    {
        //// follow
        {
            ...
            {
                //// Text off Drawing
                CGRect textOffRect = CGRectMake(CGRectGetMinX(followFrame) + 34.11, CGRectGetMinY(followFrame) + 1.91, CGRectGetWidth(followFrame) - 50.2, 34);
                {
    ...
    if (on)
    {
        //// following
        {
            ...
            //// Text on Drawing
            CGRect textOnRect = CGRectMake(CGRectGetMinX(followingFrame) + 31.47, CGRectGetMinY(followingFrame) + 1.91, CGRectGetWidth(followingFrame) - 42.37, CGRectGetHeight(followingFrame) - 4);
            {
                ...
                NSDictionary* textOnFontAttributes = @{NSFontAttributeName: [UIFont systemFontOfSize: UIFont.systemFontSize], NSForegroundColorAttributeName: TungPodcastStyleKit.tungColorMediumLight, NSParagraphStyleAttributeName: textOnStyle};
