...
//  Tung
//
//  Created by Jamie Perkins on 3/27/17.
//  Copyright (c) 2017 Inorganik Produce, Inc. All rights reserved.
//
...
+ (void)initialize
{
    ...
    _color4 = [UIColor colorWithRed: 0.3 green: 0.4 blue: 0.74 alpha: 1];
...
+ (void)drawFollowButtonWithFrame: (CGRect)frame on: (BOOL)on down: (BOOL)down
{
    ...
    if (on)
    {
        //// following
        {
            ...
            [TungPodcastStyleKit.green setFill];
            [ovalPath fill];
            [TungPodcastStyleKit.green setStroke];
            ovalPath.lineWidth = 1;
            [ovalPath stroke];
            ...
            [TungPodcastStyleKit drawCheckmarkIconWithFrame: CGRectMake(0, 0, symbolRect.size.width, symbolRect.size.height) color: white];
            CGContextRestoreGState(context);
        }
    }
}
...
+ (void)drawSaveWithProgressWithFrame: (CGRect)frame on: (BOOL)on arc: (CGFloat)arc queued: (BOOL)queued
{
    ...
    //// Subframes
    CGRect group2 = CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame) + CGRectGetHeight(frame) - 39, 30, 31);
    CGRect group = CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame) + CGRectGetHeight(frame) - 39, 30, 31);
    ...
    if (on)
    {
        ...
        {
            //// Oval 2 Drawing
            UIBezierPath* oval2Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(group2), CGRectGetMinY(group2) + 1, 30, 30)];
            [TungPodcastStyleKit.tungColor setFill];
            [oval2Path fill];


            //// downloaded Drawing
            CGRect downloadedRect = CGRectMake(CGRectGetMinX(group2), CGRectGetMinY(group2), 30, 30);
            CGContextSaveGState(context);
    ...
    if (notOn)
    {
        //// Group
        {
            //// Oval Drawing
            CGContextSaveGState(context);
            CGContextTranslateCTM(context, CGRectGetMinX(group) + 15, CGRectGetMinY(group) + 16);
            ...
            {
                //// download Drawing
                CGRect downloadRect = CGRectMake(CGRectGetMinX(group), CGRectGetMinY(group), 30, 30);
                CGContextSaveGState(context);
            ...
            {
                //// cancel Drawing
                CGRect cancelRect = CGRectMake(CGRectGetMinX(group), CGRectGetMinY(group) + 1, 30, 30);
                CGContextSaveGState(context);
