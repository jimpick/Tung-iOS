...
//  Tung
//
//  Created by Jamie Perkins on 10/27/15.
...
+ (void)drawProfileIconWithFrame: (CGRect)frame color: (UIColor*)color
{
    ...
    //// Group
    {
        ...
        CGContextTranslateCTM(context, CGRectGetMinX(frame) + 20.1, CGRectGetMinY(frame) + 19);
        CGContextRotateCTM(context, 0.15 * M_PI / 180);

        UIBezierPath* ovalPath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(-9.72, -11.17, 19.44, 22.34)];
        [color setFill];
        [ovalPath fill];
        ...
        //// Bezier Drawing
        UIBezierPath* bezierPath = [UIBezierPath bezierPath];
        [bezierPath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 31.67, CGRectGetMinY(frame) + 35.67)];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 20.03, CGRectGetMinY(frame) + 31.88) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 29.12, CGRectGetMinY(frame) + 33.3) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 24.77, CGRectGetMinY(frame) + 31.88)];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 8.23, CGRectGetMinY(frame) + 35.84) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 15.16, CGRectGetMinY(frame) + 31.88) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 10.75, CGRectGetMinY(frame) + 33.36)];
        [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 7.79, CGRectGetMinY(frame) + 36.27)];
        [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 8.35, CGRectGetMinY(frame) + 36.52)];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 19.77, CGRectGetMinY(frame) + 38.81) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 11.66, CGRectGetMinY(frame) + 38.02) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 15.61, CGRectGetMinY(frame) + 38.81)];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 31.56, CGRectGetMinY(frame) + 36.36) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 24.06, CGRectGetMinY(frame) + 38.81) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 28.25, CGRectGetMinY(frame) + 37.94)];
        [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 32.12, CGRectGetMinY(frame) + 36.09)];
        [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 31.67, CGRectGetMinY(frame) + 35.67)];
        [bezierPath closePath];
        [color setFill];
        [bezierPath fill];
        ...
        //// Bezier 2 Drawing
        UIBezierPath* bezier2Path = [UIBezierPath bezierPath];
        [bezier2Path moveToPoint: CGPointMake(CGRectGetMinX(frame) + 6.67, CGRectGetMinY(frame) + 15.25)];
        [bezier2Path addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 19.97, CGRectGetMinY(frame) + 1.98) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 6.67, CGRectGetMinY(frame) + 7.92) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 12.63, CGRectGetMinY(frame) + 1.98)];
        [bezier2Path addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 33.27, CGRectGetMinY(frame) + 15.25) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 27.32, CGRectGetMinY(frame) + 1.98) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 33.27, CGRectGetMinY(frame) + 7.92)];
        [color setStroke];
        bezier2Path.lineWidth = 1;
        [bezier2Path stroke];
        ...
        //// Bezier 3 Drawing
        UIBezierPath* bezier3Path = [UIBezierPath bezierPath];
        [bezier3Path moveToPoint: CGPointMake(CGRectGetMinX(frame) + 8.04, CGRectGetMinY(frame) + 14.59)];
        [bezier3Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 5.97, CGRectGetMinY(frame) + 14.59)];
        [bezier3Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 5.97, CGRectGetMinY(frame) + 22.53)];
        [bezier3Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 8.04, CGRectGetMinY(frame) + 22.53)];
        [bezier3Path addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 10.25, CGRectGetMinY(frame) + 20.32) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 9.26, CGRectGetMinY(frame) + 22.53) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 10.25, CGRectGetMinY(frame) + 21.54)];
        [bezier3Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 10.25, CGRectGetMinY(frame) + 16.8)];
        [bezier3Path addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 8.04, CGRectGetMinY(frame) + 14.59) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 10.25, CGRectGetMinY(frame) + 15.58) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 9.26, CGRectGetMinY(frame) + 14.59)];
        [bezier3Path closePath];
        [color setFill];
        [bezier3Path fill];
        ...
        //// Bezier 4 Drawing
        UIBezierPath* bezier4Path = [UIBezierPath bezierPath];
        [bezier4Path moveToPoint: CGPointMake(CGRectGetMinX(frame) + 31.93, CGRectGetMinY(frame) + 14.59)];
        [bezier4Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 34, CGRectGetMinY(frame) + 14.59)];
        [bezier4Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 34, CGRectGetMinY(frame) + 22.53)];
        [bezier4Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 31.93, CGRectGetMinY(frame) + 22.53)];
        [bezier4Path addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 29.72, CGRectGetMinY(frame) + 20.32) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 30.71, CGRectGetMinY(frame) + 22.53) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 29.72, CGRectGetMinY(frame) + 21.54)];
        [bezier4Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 29.72, CGRectGetMinY(frame) + 16.8)];
        [bezier4Path addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 31.93, CGRectGetMinY(frame) + 14.59) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 29.72, CGRectGetMinY(frame) + 15.58) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 30.71, CGRectGetMinY(frame) + 14.59)];
        [bezier4Path closePath];
        [color setFill];
        [bezier4Path fill];
    }
...
+ (void)drawHideControlsButtonWithFrame: (CGRect)frame
{
    ...
    //// Symbol Drawing
    CGRect symbolRect = CGRectMake(CGRectGetMinX(frame) + floor((CGRectGetWidth(frame) - 41) * 0.47619 + 0.5), CGRectGetMinY(frame) + 7, 41, 13);
    CGContextSaveGState(context);
    UIRectClip(symbolRect);
    CGContextTranslateCTM(context, symbolRect.origin.x, symbolRect.origin.y);
...
+ (void)drawFollowButtonWithFrame: (CGRect)frame on: (BOOL)on down: (BOOL)down
{
    ...
    if (notOn)
    {
        //// follow
        {
            //// Bezier up state 2 Drawing
            UIBezierPath* bezierUpState2Path = [UIBezierPath bezierPath];
            [bezierUpState2Path moveToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91)];
            [bezierUpState2Path addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 115.4, CGRectGetMinY(frame) + 35.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 28.3) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 124.79, CGRectGetMinY(frame) + 35.91)];
            [bezierUpState2Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 18.47, CGRectGetMinY(frame) + 35.91)];
            [bezierUpState2Path addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 18.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 9.08, CGRectGetMinY(frame) + 35.91) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 28.3)];
            [bezierUpState2Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 18.91)];
            [bezierUpState2Path addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 18.47, CGRectGetMinY(frame) + 1.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 9.52) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 9.08, CGRectGetMinY(frame) + 1.91)];
            [bezierUpState2Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 115.4, CGRectGetMinY(frame) + 1.91)];
            [bezierUpState2Path addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 124.79, CGRectGetMinY(frame) + 1.91) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 9.52)];
            [bezierUpState2Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91)];
            [bezierUpState2Path closePath];
            [TungPodcastStyleKit.tungColorMediumLight setFill];
            [bezierUpState2Path fill];


            if (down)
            {
                //// Bezier off down Drawing
                UIBezierPath* bezierOffDownPath = [UIBezierPath bezierPath];
                [bezierOffDownPath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91)];
                [bezierOffDownPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 115.4, CGRectGetMinY(frame) + 35.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 28.3) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 124.79, CGRectGetMinY(frame) + 35.91)];
                [bezierOffDownPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 18.47, CGRectGetMinY(frame) + 35.91)];
                [bezierOffDownPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 18.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 9.08, CGRectGetMinY(frame) + 35.91) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 28.3)];
                [bezierOffDownPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 18.91)];
                [bezierOffDownPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 18.47, CGRectGetMinY(frame) + 1.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 9.52) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 9.08, CGRectGetMinY(frame) + 1.91)];
                [bezierOffDownPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 115.4, CGRectGetMinY(frame) + 1.91)];
                [bezierOffDownPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 124.79, CGRectGetMinY(frame) + 1.91) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 9.52)];
                [bezierOffDownPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91)];
                [bezierOffDownPath closePath];
                [black15Alpha setFill];
                [bezierOffDownPath fill];
            }


            //// Bezier off outline Drawing
            UIBezierPath* bezierOffOutlinePath = [UIBezierPath bezierPath];
            [bezierOffOutlinePath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91)];
            [bezierOffOutlinePath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 115.4, CGRectGetMinY(frame) + 35.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 28.3) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 124.79, CGRectGetMinY(frame) + 35.91)];
            [bezierOffOutlinePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 18.47, CGRectGetMinY(frame) + 35.91)];
            [bezierOffOutlinePath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 18.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 9.08, CGRectGetMinY(frame) + 35.91) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 28.3)];
            [bezierOffOutlinePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 18.91)];
            [bezierOffOutlinePath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 18.47, CGRectGetMinY(frame) + 1.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 9.52) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 9.08, CGRectGetMinY(frame) + 1.91)];
            [bezierOffOutlinePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 115.4, CGRectGetMinY(frame) + 1.91)];
            [bezierOffOutlinePath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 124.79, CGRectGetMinY(frame) + 1.91) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 9.52)];
            [bezierOffOutlinePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91)];
            [bezierOffOutlinePath closePath];
            [UIColor.whiteColor setStroke];
            bezierOffOutlinePath.lineWidth = 1;
            [bezierOffOutlinePath stroke];


            //// Oval 2 Drawing
            UIBezierPath* oval2Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(frame) + 4.4, CGRectGetMinY(frame) + 4.48, 28.86, 28.86)];
            [white setFill];
            [oval2Path fill];


            //// Symbol 2 Drawing
            CGRect symbol2Rect = CGRectMake(CGRectGetMinX(frame) + 5.21, CGRectGetMinY(frame) + 5.29, 27.24, 27.24);
            CGContextSaveGState(context);
            UIRectClip(symbol2Rect);
            CGContextTranslateCTM(context, symbol2Rect.origin.x, symbol2Rect.origin.y);
            ...
            {
                //// Text off Drawing
                CGRect textOffRect = CGRectMake(CGRectGetMinX(frame) + 34.11, CGRectGetMinY(frame) + 1.91, 83.8, 34);
                {
    ...
    if (on)
    {
        //// following
        {
            if (on)
            {
                //// Bezier on bkgd Drawing
                UIBezierPath* bezierOnBkgdPath = [UIBezierPath bezierPath];
                [bezierOnBkgdPath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91)];
                [bezierOnBkgdPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 115.4, CGRectGetMinY(frame) + 35.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 28.3) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 124.79, CGRectGetMinY(frame) + 35.91)];
                [bezierOnBkgdPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 18.47, CGRectGetMinY(frame) + 35.91)];
                [bezierOnBkgdPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 18.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 9.08, CGRectGetMinY(frame) + 35.91) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 28.3)];
                [bezierOnBkgdPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 18.91)];
                [bezierOnBkgdPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 18.47, CGRectGetMinY(frame) + 1.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 9.52) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 9.08, CGRectGetMinY(frame) + 1.91)];
                [bezierOnBkgdPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 115.4, CGRectGetMinY(frame) + 1.91)];
                [bezierOnBkgdPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 124.79, CGRectGetMinY(frame) + 1.91) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 9.52)];
                [bezierOnBkgdPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91)];
                [bezierOnBkgdPath closePath];
                [UIColor.whiteColor setFill];
                [bezierOnBkgdPath fill];
            }


            if (downAndOn)
            {
                //// Bezier on down Drawing
                UIBezierPath* bezierOnDownPath = [UIBezierPath bezierPath];
                [bezierOnDownPath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91)];
                [bezierOnDownPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 115.4, CGRectGetMinY(frame) + 35.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 28.3) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 124.79, CGRectGetMinY(frame) + 35.91)];
                [bezierOnDownPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 18.47, CGRectGetMinY(frame) + 35.91)];
                [bezierOnDownPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 18.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 9.08, CGRectGetMinY(frame) + 35.91) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 28.3)];
                [bezierOnDownPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 18.91)];
                [bezierOnDownPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 18.47, CGRectGetMinY(frame) + 1.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 9.52) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 9.08, CGRectGetMinY(frame) + 1.91)];
                [bezierOnDownPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 115.4, CGRectGetMinY(frame) + 1.91)];
                [bezierOnDownPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 124.79, CGRectGetMinY(frame) + 1.91) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 9.52)];
                [bezierOnDownPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91)];
                [bezierOnDownPath closePath];
                [black10Alpha setFill];
                [bezierOnDownPath fill];
            }


            if (on)
            {
                //// Bezier on outline Drawing
                UIBezierPath* bezierOnOutlinePath = [UIBezierPath bezierPath];
                [bezierOnOutlinePath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91)];
                [bezierOnOutlinePath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 115.4, CGRectGetMinY(frame) + 35.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 28.3) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 124.79, CGRectGetMinY(frame) + 35.91)];
                [bezierOnOutlinePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 18.47, CGRectGetMinY(frame) + 35.91)];
                [bezierOnOutlinePath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 18.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 9.08, CGRectGetMinY(frame) + 35.91) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 28.3)];
                [bezierOnOutlinePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 18.91)];
                [bezierOnOutlinePath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 18.47, CGRectGetMinY(frame) + 1.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 1.47, CGRectGetMinY(frame) + 9.52) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 9.08, CGRectGetMinY(frame) + 1.91)];
                [bezierOnOutlinePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 115.4, CGRectGetMinY(frame) + 1.91)];
                [bezierOnOutlinePath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 124.79, CGRectGetMinY(frame) + 1.91) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 9.52)];
                [bezierOnOutlinePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 132.4, CGRectGetMinY(frame) + 18.91)];
                [bezierOnOutlinePath closePath];
                [TungPodcastStyleKit.tungColorMediumLight setStroke];
                bezierOnOutlinePath.lineWidth = 1;
                [bezierOnOutlinePath stroke];
            }


            //// Text on Drawing
            CGRect textOnRect = CGRectMake(CGRectGetMinX(frame) + 33.96, CGRectGetMinY(frame) + 1.91, 90.29, 34);
            {
                ...
                NSDictionary* textOnFontAttributes = @{NSFontAttributeName: [UIFont systemFontOfSize: 15], NSForegroundColorAttributeName: TungPodcastStyleKit.tungColorMediumLight, NSParagraphStyleAttributeName: textOnStyle};
            ...
            //// Oval Drawing
            UIBezierPath* ovalPath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(frame) + 4.4, CGRectGetMinY(frame) + 4.48, 28.86, 28.86)];
            [TungPodcastStyleKit.tungColorMediumLight setStroke];
            ovalPath.lineWidth = 1;
            [ovalPath stroke];
            ...
            //// Symbol Drawing
            CGRect symbolRect = CGRectMake(CGRectGetMinX(frame) + 5.21, CGRectGetMinY(frame) + 5.29, 27.24, 27.24);
            CGContextSaveGState(context);
            UIRectClip(symbolRect);
            CGContextTranslateCTM(context, symbolRect.origin.x, symbolRect.origin.y);
...
+ (void)drawSignUpWithTwitterWithFrame: (CGRect)frame down: (BOOL)down
{
    ...
    UIColor* white = [UIColor colorWithRed: 1 green: 1 blue: 1 alpha: 1];
    UIColor* twitterBlue = [UIColor colorWithRed: 0.165 green: 0.663 blue: 0.878 alpha: 1];
    UIColor* twitter20 = [twitterBlue colorWithAlphaComponent: 0.2];
    ...
    if (notDown)
    {
        //// Bezier Drawing
        UIBezierPath* bezierPath = [UIBezierPath bezierPath];
        [bezierPath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.94993 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.15625 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.94993 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.84372 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 1.01068 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.34609 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 1.01068 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.65388 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.83992 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.98610 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.91955 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.93864 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.87973 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.98610 * CGRectGetHeight(frame))];
        [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 0.16008 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.98610 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.05007 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.84372 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.12027 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.98610 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.08045 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.93864 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.05007 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.15625 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + -0.01068 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.65388 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + -0.01068 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.34609 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.16008 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.01388 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.08045 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.06133 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.12027 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.01388 * CGRectGetHeight(frame))];
        [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 0.83992 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.01388 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.94993 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.15625 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.87973 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.01388 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.91955 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.06133 * CGRectGetHeight(frame))];
        [bezierPath closePath];
        [UIColor.whiteColor setFill];
        [bezierPath fill];
        [twitterBlue setStroke];
    ...
    //// Text Drawing
    CGRect textRect = CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.29094 - 0.09) + 0.59, CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.23173 + 0.18) + 0.32, floor(CGRectGetWidth(frame) * 0.97975 - 0) - floor(CGRectGetWidth(frame) * 0.29094 - 0.09) - 0.08, floor(CGRectGetHeight(frame) * 0.75950 + 0.18) - floor(CGRectGetHeight(frame) * 0.23173 + 0.18));
    {
        NSString* textContent = @"sign-in or sign-up";
        NSMutableParagraphStyle* textStyle = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
        textStyle.alignment = NSTextAlignmentCenter;

        NSDictionary* textFontAttributes = @{NSFontAttributeName: [UIFont systemFontOfSize: UIFont.labelFontSize], NSForegroundColorAttributeName: twitterBlue, NSParagraphStyleAttributeName: textStyle};
    ...
    //// Oval Drawing
    UIBezierPath* ovalPath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.02517 - 0.09) + 0.59, CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.06506 + 0.18) + 0.32, floor(CGRectGetWidth(frame) * 0.29995 - 0.09) - floor(CGRectGetWidth(frame) * 0.02517 - 0.09), floor(CGRectGetHeight(frame) * 0.92617 + 0.18) - floor(CGRectGetHeight(frame) * 0.06506 + 0.18))];
    [twitterBlue setFill];
    [ovalPath fill];


    //// Symbol Drawing
    CGRect symbolRect = CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.07658 + 0.5), CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.23513 + 0.43) + 0.07, floor(CGRectGetWidth(frame) * 0.25225 + 0.5) - floor(CGRectGetWidth(frame) * 0.07658 + 0.5), floor(CGRectGetHeight(frame) * 0.79069 + 0.43) - floor(CGRectGetHeight(frame) * 0.23513 + 0.43));
    CGContextSaveGState(context);
    UIRectClip(symbolRect);
    CGContextTranslateCTM(context, symbolRect.origin.x, symbolRect.origin.y);

    [TungPodcastStyleKit drawTwitterIconWithFrame: CGRectMake(0, 0, symbolRect.size.width, symbolRect.size.height) color: white on: NO];
    CGContextRestoreGState(context);
}
...
+ (void)drawSignUpWithFacebookWithFrame: (CGRect)frame down: (BOOL)down
{
    ...
    UIColor* white = [UIColor colorWithRed: 1 green: 1 blue: 1 alpha: 1];
    UIColor* facebookBlue = [UIColor colorWithRed: 0.239 green: 0.353 blue: 0.596 alpha: 1];
    UIColor* facebook20 = [facebookBlue colorWithAlphaComponent: 0.2];
    ...
    if (notDown)
    {
        //// Bezier Drawing
        UIBezierPath* bezierPath = [UIBezierPath bezierPath];
        [bezierPath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.94992 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.15627 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.94992 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.84373 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 1.01068 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.34611 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 1.01068 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.65389 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.83991 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.98611 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.91954 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.93865 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.87973 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.98611 * CGRectGetHeight(frame))];
        [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 0.16007 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.98611 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.05007 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.84373 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.12026 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.98611 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.08044 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.93865 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.05007 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.15627 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + -0.01069 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.65389 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + -0.01069 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.34611 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.16007 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.01389 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.08044 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.06135 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.12026 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.01389 * CGRectGetHeight(frame))];
        [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 0.83991 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.01389 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.94992 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.15627 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.87973 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.01389 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.91954 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.06135 * CGRectGetHeight(frame))];
        [bezierPath closePath];
        [UIColor.whiteColor setFill];
        [bezierPath fill];
        [facebookBlue setStroke];
    ...
    //// Text Drawing
    CGRect textRect = CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.29544 - 0.09) + 0.59, CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.23794 - 0.37) + 0.87, floor(CGRectGetWidth(frame) * 0.99327 - 0) - floor(CGRectGetWidth(frame) * 0.29544 - 0.09) - 0.08, floor(CGRectGetHeight(frame) * 0.76572 - 0.37) - floor(CGRectGetHeight(frame) * 0.23794 - 0.37));
    {
        NSString* textContent = @"sign-in or sign-up";
        NSMutableParagraphStyle* textStyle = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
        textStyle.alignment = NSTextAlignmentCenter;

        NSDictionary* textFontAttributes = @{NSFontAttributeName: [UIFont systemFontOfSize: UIFont.labelFontSize], NSForegroundColorAttributeName: facebookBlue, NSParagraphStyleAttributeName: textStyle};
    ...
    //// Oval Drawing
    UIBezierPath* ovalPath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.02517 - 0.09) + 0.59, CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.07127 - 0.37) + 0.87, floor(CGRectGetWidth(frame) * 0.30445 - 0.09) - floor(CGRectGetWidth(frame) * 0.02517 - 0.09), floor(CGRectGetHeight(frame) * 0.93238 - 0.37) - floor(CGRectGetHeight(frame) * 0.07127 - 0.37))];
    [facebookBlue setFill];
    [ovalPath fill];


    //// Symbol Drawing
    CGRect symbolRect = CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.06757 + 0.5), CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.22746 - 0.12) + 0.62, floor(CGRectGetWidth(frame) * 0.24775 + 0.5) - floor(CGRectGetWidth(frame) * 0.06757 + 0.5), floor(CGRectGetHeight(frame) * 0.78301 - 0.12) - floor(CGRectGetHeight(frame) * 0.22746 - 0.12));
    CGContextSaveGState(context);
    UIRectClip(symbolRect);
    CGContextTranslateCTM(context, symbolRect.origin.x, symbolRect.origin.y);

    [TungPodcastStyleKit drawFacebookIconWithFrame: CGRectMake(0, 0, symbolRect.size.width, symbolRect.size.height) color: white on: NO];
    CGContextRestoreGState(context);
}
...
+ (void)drawSupportButtonWithFrame: (CGRect)frame down: (BOOL)down
{
    ...
    if (down)
    {
        ...
        [bezier2Path addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 20.39, CGRectGetMinY(frame) + 1.00000 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(-0.02, 31.82) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 9.12, CGRectGetMinY(frame) + 1.00000 * CGRectGetHeight(frame))];
        [bezier2Path addLineToPoint: CGPointMake(CGRectGetMaxX(frame) - 20.44, CGRectGetMinY(frame) + 1.00000 * CGRectGetHeight(frame))];
        [bezier2Path addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 0.02, CGRectGetMinY(frame) + 0.50000 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 9.16, CGRectGetMinY(frame) + 1.00000 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 0.02, CGRectGetMinY(frame) + 0.77611 * CGRectGetHeight(frame))];
        [bezier2Path addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 20.44, CGRectGetMinY(frame) + 0.00000 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 0.02, CGRectGetMinY(frame) + 0.22386 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 9.16, CGRectGetMinY(frame) + 0.00000 * CGRectGetHeight(frame))];
        [bezier2Path closePath];
        [black25Alpha setFill];
        [bezier2Path fill];
    }
    ...
    if (notDown)
    {
        ...
        [bezierPath moveToPoint: CGPointMake(CGRectGetMaxX(frame) - 20.42, CGRectGetMinY(frame) + 0.00000 * CGRectGetHeight(frame))];
        [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 20.41, CGRectGetMinY(frame) + 0.00000 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame), CGRectGetMinY(frame) + 0.50000 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 9.14, CGRectGetMinY(frame) + 0.00000 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame), CGRectGetMinY(frame) + 0.22386 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 20.41, CGRectGetMinY(frame) + 1.00000 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame), CGRectGetMinY(frame) + 0.77611 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 9.14, CGRectGetMinY(frame) + 1.00000 * CGRectGetHeight(frame))];
        [bezierPath addLineToPoint: CGPointMake(CGRectGetMaxX(frame) - 20.42, CGRectGetMinY(frame) + 1.00000 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame), CGRectGetMinY(frame) + 0.50000 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 9.14, CGRectGetMinY(frame) + 1.00000 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMaxX(frame), CGRectGetMinY(frame) + 0.77611 * CGRectGetHeight(frame))];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 20.42, CGRectGetMinY(frame) + 0.00000 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMaxX(frame), CGRectGetMinY(frame) + 0.22386 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 9.14, CGRectGetMinY(frame) + 0.00000 * CGRectGetHeight(frame))];
        [bezierPath closePath];
        [black15Alpha setFill];
        [bezierPath fill];
    }
    ...
    //// Symbol Drawing
    CGRect symbolRect = CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.28494 - 0.01) + 0.51, CGRectGetMinY(frame) + 2, floor(CGRectGetWidth(frame) * 0.71506 - 0.01) - floor(CGRectGetWidth(frame) * 0.28494 - 0.01), CGRectGetHeight(frame) - 4);
    CGContextSaveGState(context);
    UIRectClip(symbolRect);
    CGContextTranslateCTM(context, symbolRect.origin.x, symbolRect.origin.y);
...
+ (void)drawEpisodeProgressWithOuterFrame: (CGRect)outerFrame progress: (CGFloat)progress
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
    ...
    //// Variable Declarations
    CGFloat expression = progress * 50;
    ...
    //// Group
    {
        ...
        //// Clip pill shape
        UIBezierPath* pillShapePath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(CGRectGetMinX(outerFrame), CGRectGetMinY(outerFrame), 50, 7) cornerRadius: 3.4];
        [pillShapePath addClip];


        //// Rectangle 4 Drawing
        UIBezierPath* rectangle4Path = [UIBezierPath bezierPathWithRect: CGRectMake(CGRectGetMinX(outerFrame), CGRectGetMinY(outerFrame) - 2.48, 50, 12.16)];
        [TungPodcastStyleKit.tungColor setFill];
        [rectangle4Path fill];


        //// Rectangle 2 Drawing
        UIBezierPath* rectangle2Path = [UIBezierPath bezierPathWithRect: CGRectMake(0, -2.44, expression, 12.16)];
        [lightGray setFill];
        [rectangle2Path fill];
