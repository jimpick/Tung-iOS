...
//  Tung
//
//  Created by Jamie Perkins on 11/4/15.
...
+ (void)drawClipIconRandomWithFrame: (CGRect)frame
{
    ...
    //// Bezier 6 Drawing
    UIBezierPath* bezier6Path = [UIBezierPath bezierPath];
    [bezier6Path moveToPoint: CGPointMake(CGRectGetMinX(frame) + 17.27, CGRectGetMinY(frame) + 6.12)];
    [bezier6Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 17.27, CGRectGetMinY(frame) + 34.12)];
    bezier6Path.lineCapStyle = kCGLineCapRound;
    ...
    //// Bezier 7 Drawing
    UIBezierPath* bezier7Path = [UIBezierPath bezierPath];
    [bezier7Path moveToPoint: CGPointMake(CGRectGetMinX(frame) + 20.07, CGRectGetMinY(frame) + 6.12)];
    [bezier7Path addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 20.07, CGRectGetMinY(frame) + 34.12)];
    bezier7Path.lineCapStyle = kCGLineCapRound;
