...
//  Tung
//
//  Created by Jamie Perkins on 9/30/15.
...
+ (void)drawClipIconWithFrame: (CGRect)frame color: (UIColor*)color
{
    ...
    //// Subframes
    CGRect group2 = CGRectMake(CGRectGetMinX(frame) + floor((CGRectGetWidth(frame) - 27.5) * 0.48001 + 0.5), CGRectGetMinY(frame) + floor((CGRectGetHeight(frame) - 28.55) * 0.52392 + 0.05) + 0.45, 27.5, 28.55);
    ...
    //// Group 2
    {
        //// Bezier Drawing
        UIBezierPath* bezierPath = [UIBezierPath bezierPath];
        [bezierPath moveToPoint: CGPointMake(CGRectGetMinX(group2) + 0.66, CGRectGetMinY(group2) + 17.48)];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(group2), CGRectGetMinY(group2) + 16.82) controlPoint1: CGPointMake(CGRectGetMinX(group2) + 0.29, CGRectGetMinY(group2) + 17.48) controlPoint2: CGPointMake(CGRectGetMinX(group2), CGRectGetMinY(group2) + 17.18)];
        [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(group2), CGRectGetMinY(group2) + 11.73)];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(group2) + 0.66, CGRectGetMinY(group2) + 11.07) controlPoint1: CGPointMake(CGRectGetMinX(group2), CGRectGetMinY(group2) + 11.37) controlPoint2: CGPointMake(CGRectGetMinX(group2) + 0.29, CGRectGetMinY(group2) + 11.07)];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(group2) + 1.32, CGRectGetMinY(group2) + 11.73) controlPoint1: CGPointMake(CGRectGetMinX(group2) + 1.02, CGRectGetMinY(group2) + 11.07) controlPoint2: CGPointMake(CGRectGetMinX(group2) + 1.32, CGRectGetMinY(group2) + 11.37)];
        [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(group2) + 1.32, CGRectGetMinY(group2) + 16.82)];
        [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(group2) + 0.66, CGRectGetMinY(group2) + 17.48) controlPoint1: CGPointMake(CGRectGetMinX(group2) + 1.32, CGRectGetMinY(group2) + 17.18) controlPoint2: CGPointMake(CGRectGetMinX(group2) + 1.02, CGRectGetMinY(group2) + 17.48)];
        [bezierPath closePath];
        [color setFill];
        [bezierPath fill];
        ...
        //// Rectangle Drawing
        UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(CGRectGetMinX(group2) + 2.65, CGRectGetMinY(group2) + 7.5, 1.3, 13.6) cornerRadius: 0.6];
        [color setFill];
        [rectanglePath fill];


        //// Rectangle 2 Drawing
        UIBezierPath* rectangle2Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(CGRectGetMinX(group2) + 5.25, CGRectGetMinY(group2) + 9.22, 1.3, 10.15) cornerRadius: 0.6];
        [color setFill];
        [rectangle2Path fill];


        //// Rectangle 3 Drawing
        UIBezierPath* rectangle3Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(CGRectGetMinX(group2) + 7.85, CGRectGetMinY(group2) + 5.37, 1.3, 17.85) cornerRadius: 0.6];
        [color setFill];
        [rectangle3Path fill];


        //// Rectangle 4 Drawing
        UIBezierPath* rectangle4Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(CGRectGetMinX(group2) + 10.5, CGRectGetMinY(group2) + 12.12, 1.3, 4.35) cornerRadius: 0.6];
        [color setFill];
        [rectangle4Path fill];


        //// Rectangle 5 Drawing
        UIBezierPath* rectangle5Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(CGRectGetMinX(group2) + 13.1, CGRectGetMinY(group2) + 9.57, 1.3, 9.45) cornerRadius: 0.6];
        [color setFill];
        [rectangle5Path fill];


        //// Rectangle 6 Drawing
        UIBezierPath* rectangle6Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(CGRectGetMinX(group2) + 15.75, CGRectGetMinY(group2) + 3, 1.3, 22.6) cornerRadius: 0.6];
        [color setFill];
        [rectangle6Path fill];
        ...
        //// Bezier 2 Drawing
        UIBezierPath* bezier2Path = [UIBezierPath bezierPath];
        [bezier2Path moveToPoint: CGPointMake(CGRectGetMinX(group2) + 19.01, CGRectGetMinY(group2) + 28.55)];
        [bezier2Path addCurveToPoint: CGPointMake(CGRectGetMinX(group2) + 18.35, CGRectGetMinY(group2) + 27.89) controlPoint1: CGPointMake(CGRectGetMinX(group2) + 18.64, CGRectGetMinY(group2) + 28.55) controlPoint2: CGPointMake(CGRectGetMinX(group2) + 18.35, CGRectGetMinY(group2) + 28.25)];
        [bezier2Path addLineToPoint: CGPointMake(CGRectGetMinX(group2) + 18.35, CGRectGetMinY(group2) + 0.66)];
        [bezier2Path addCurveToPoint: CGPointMake(CGRectGetMinX(group2) + 19.01, CGRectGetMinY(group2)) controlPoint1: CGPointMake(CGRectGetMinX(group2) + 18.35, CGRectGetMinY(group2) + 0.3) controlPoint2: CGPointMake(CGRectGetMinX(group2) + 18.64, CGRectGetMinY(group2))];
        [bezier2Path addCurveToPoint: CGPointMake(CGRectGetMinX(group2) + 19.67, CGRectGetMinY(group2) + 0.66) controlPoint1: CGPointMake(CGRectGetMinX(group2) + 19.37, CGRectGetMinY(group2)) controlPoint2: CGPointMake(CGRectGetMinX(group2) + 19.67, CGRectGetMinY(group2) + 0.3)];
        [bezier2Path addLineToPoint: CGPointMake(CGRectGetMinX(group2) + 19.67, CGRectGetMinY(group2) + 27.89)];
        [bezier2Path addCurveToPoint: CGPointMake(CGRectGetMinX(group2) + 19.01, CGRectGetMinY(group2) + 28.55) controlPoint1: CGPointMake(CGRectGetMinX(group2) + 19.67, CGRectGetMinY(group2) + 28.25) controlPoint2: CGPointMake(CGRectGetMinX(group2) + 19.37, CGRectGetMinY(group2) + 28.55)];
        [bezier2Path closePath];
        [color setFill];
        [bezier2Path fill];
        ...
        //// Rectangle 7 Drawing
        UIBezierPath* rectangle7Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(CGRectGetMinX(group2) + 21, CGRectGetMinY(group2) + 7.5, 1.3, 13.6) cornerRadius: 0.6];
        [color setFill];
        [rectangle7Path fill];


        //// Rectangle 8 Drawing
        UIBezierPath* rectangle8Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(CGRectGetMinX(group2) + 23.6, CGRectGetMinY(group2) + 4.12, 1.3, 20.35) cornerRadius: 0.6];
        [color setFill];
        [rectangle8Path fill];


        //// Rectangle 9 Drawing
        UIBezierPath* rectangle9Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(CGRectGetMinX(group2) + 26.2, CGRectGetMinY(group2) + 10.02, 1.3, 8.55) cornerRadius: 0.6];
        [color setFill];
        [rectangle9Path fill];
    }
}
...
+ (void)drawClipButtonWithFrame: (CGRect)frame color: (UIColor*)color down: (BOOL)down
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
    ...
    [TungPodcastStyleKit drawClipIconWithFrame: CGRectMake(0, 0, symbolRect.size.width, symbolRect.size.height) color: color];
    CGContextRestoreGState(context);
}
