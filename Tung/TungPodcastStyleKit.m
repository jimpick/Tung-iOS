...
//  Tung
//
//  Created by Jamie Perkins on 5/17/16.
...
+ (void)drawSettingsIconWithFrame: (CGRect)frame color: (UIColor*)color
{
    ...
    //// Subframes
    CGRect group = CGRectMake(CGRectGetMinX(frame) + 0.5, CGRectGetMinY(frame) + 6.76, CGRectGetWidth(frame) - 13.84, CGRectGetHeight(frame) - 12.84);
