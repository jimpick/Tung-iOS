...
- (void)setUp
{
    ...
    _opacityView.backgroundColor = [UIColor clearColor];
    [self insertSubview:_opacityView atIndex:10];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[_opacityView]|"
                                                                 options:0
                                                                 metrics:0
                                                                   views:NSDictionaryOfVariableBindings(_opacityView)]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[_opacityView]|"
                                                                 options:0
                                                                 metrics:0
                                                                   views:NSDictionaryOfVariableBindings(_opacityView)]];
...
- (void)setTintColor:(UIColor *)tintColor
{
    ...
    UIColor *opacityColor = [UIColor colorWithRed:red green:green blue:blue alpha:_opacity];
    _opacityView.backgroundColor = opacityColor;
