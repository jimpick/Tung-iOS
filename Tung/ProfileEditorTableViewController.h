//
//  ProfileEditorTableViewController.h
//  Tung
//
...
@interface ProfileEditorTableViewController : UITableViewController <UITextViewDelegate, UITextFieldDelegate, UIAlertViewDelegate>
